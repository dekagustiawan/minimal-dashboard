package com.dekapanca.dev.views.testimonial;

import com.dekapanca.dev.views.MainLayout;
...
public class TestimonialView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public TestimonialView() {
        addClassName("testimonial-view");
        setSizeFull();
        grid.setHeight("100%");
